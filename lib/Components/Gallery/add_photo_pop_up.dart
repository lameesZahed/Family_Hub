        ...
        options: RoundedRectDottedBorderOptions(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Icon(Icons.add_photo_alternate_outlined,color: Color(0xFF6E5C52),size: 48,),
                SizedBox(height: 8,),
                Text("Drag and Drop Photos here or",style: TextStyle(
                  fontSize: 12,
